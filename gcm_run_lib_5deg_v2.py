...
def parse_cmd_line():
    ...
    parser.add_argument("--ncpus", required=True, default=40, type=int, help=("total # of cpus: skylake:40, cas: 45"))
    parser.add_argument("--ncpusPerNode", required=True, default=40, type=int, help=("skylake:40, cas: 45"))
